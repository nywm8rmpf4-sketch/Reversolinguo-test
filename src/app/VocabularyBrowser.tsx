...
export function sortVocabularyEntries(entries: LexicalEntry[], direction: Direction) {
...
export function vocabularyThemeGroups(entries: LexicalEntry[], direction: Direction) {
