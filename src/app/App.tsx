...
function AppContent() {
  ...
  if (screen === 'loading') return <main className="shell"><div className="build-identity" aria-label="Version de test">TEST v2.0-R12 · publié 22/09/2026</div><p aria-live="polite"><FormattedMessage id="loading" /></p></main>
