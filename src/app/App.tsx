...
function AppContent() {
  ...
  const flashcardStyle = themeBackground ? ({
    ...
    '--flashcard-theme-size': settings.activePairId === 'fr-en' ? 'contain' : 'cover'
  ...
  if (screen === 'loading') return <main className="shell"><div className="build-identity" aria-label="Version de test">TEST v2.0-R14 · publié 23/09/2026</div><p aria-live="polite"><FormattedMessage id="loading" /></p></main>
