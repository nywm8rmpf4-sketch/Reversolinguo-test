...
const testBuildIdentity = 'TEST v2.0-R17 · publié 24/09/2026'
...
function AppContent() {
  ...
  if (screen === 'loading') return <main className="shell"><div className="build-identity" aria-label="Version de test">{testBuildIdentity}</div><p aria-live="polite"><FormattedMessage id="loading" /></p></main>
